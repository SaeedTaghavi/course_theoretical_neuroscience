...
do it=1,10000
    Iext=2.0
    ! if (it >1000 .and. it < 1200) then 
    !     Iext=10.0
    ! end if
    call derivs(dX_dt,X,Cm, gNa, gK, gl, ENa, EK, El,Iext)
...
subroutine initiate(X)
    ...
    real(8) :: X(4)
    real(8) :: V0, n0, m0, h0
    V0 = 2.7761928636878708E-004
    n0 = 0.31768119325270772
    m0 = 5.2934220142641306E-002
    h0 = 0.59611159849599726     
    X(1) = V0
    X(2) = n0
    X(3) = m0
    X(4) = h0
...
subroutine derivs(dX_dt,X,Cm, gNa, gK, gl, ENa, EK, El,Iext)
    implicit none  
    real(8) :: X(4), dX_dt(4)  
